...
import type { ModuleRegistryEntry } from "../entities/moduleRegistry";

const SEED_MODULES: readonly ModuleRegistryEntry[] = [
  {
...
export function getModuleRegistrySeedCatalog(): readonly ModuleRegistryEntry[] {
  return SEED_MODULES;
}

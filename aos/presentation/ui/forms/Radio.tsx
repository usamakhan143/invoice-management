  ...
  ({ className, label, hasError, disabled, id, ...props }, ref) => {
    ...
    const input = (
      <input
        ...
        className={cn(
          "h-[var(--size-icon-sm)] w-[var(--size-icon-sm)] shrink-0 border border-[var(--color-border-default)] text-[var(--color-interactive-primary)] accent-[var(--color-interactive-primary)]",
          focusRing,
          disabledStyles,
          className,
        )}

...
export const GRANULAR_PERMISSIONS = {
  ...
  // Agentic Operating System (AOS) — Phase 1 Stage A scaffold
  AOS_DASHBOARD_VIEW: "aos_dashboard_view",
  AOS_ENGAGEMENTS_VIEW: "aos_engagements_view",
  AOS_ENGAGEMENTS_MANAGE: "aos_engagements_manage",
  AOS_REGISTRY_VIEW: "aos_registry_view",
  AOS_REGISTRY_MANAGE: "aos_registry_manage",
  AOS_REQUIREMENTS_VIEW: "aos_requirements_view",
  AOS_REQUIREMENTS_EDIT: "aos_requirements_edit",
  AOS_REQUIREMENTS_APPROVE: "aos_requirements_approve",
  AOS_PROMPTS_VIEW: "aos_prompts_view",
  AOS_PROMPTS_MANAGE: "aos_prompts_manage",
  AOS_CURSOR_VIEW: "aos_cursor_view",
  AOS_CURSOR_EXECUTE: "aos_cursor_execute",
  AOS_EVALUATION_VIEW: "aos_evaluation_view",
  AOS_EVALUATION_MANAGE: "aos_evaluation_manage",
  AOS_KNOWLEDGE_VIEW: "aos_knowledge_view",
  AOS_KNOWLEDGE_MANAGE: "aos_knowledge_manage",
  AOS_LEARNING_VIEW: "aos_learning_view",
  AOS_LEARNING_REVIEW: "aos_learning_review",
  AOS_LEARNING_PROMOTE: "aos_learning_promote",
  AOS_PLAYBOOK_VIEW: "aos_playbook_view",
  AOS_PLAYBOOK_MANAGE: "aos_playbook_manage",
  AOS_TEMPLATES_VIEW: "aos_templates_view",
  AOS_TEMPLATES_MANAGE: "aos_templates_manage",
  AOS_RUBRICS_VIEW: "aos_rubrics_view",
  AOS_RUBRICS_MANAGE: "aos_rubrics_manage",
  AOS_ADMIN: "aos_admin",
...
export const PERMISSION_DESCRIPTIONS = {
  ...
  // AOS
  [GRANULAR_PERMISSIONS.AOS_DASHBOARD_VIEW]: "View AOS delivery dashboard",
  [GRANULAR_PERMISSIONS.AOS_ENGAGEMENTS_VIEW]: "View delivery engagements",
  [GRANULAR_PERMISSIONS.AOS_ENGAGEMENTS_MANAGE]: "Create and update delivery engagements",
  [GRANULAR_PERMISSIONS.AOS_REGISTRY_VIEW]: "Browse module registry",
  [GRANULAR_PERMISSIONS.AOS_REGISTRY_MANAGE]: "Register and deprecate modules",
  [GRANULAR_PERMISSIONS.AOS_REQUIREMENTS_VIEW]: "View requirement sets and requirements",
  [GRANULAR_PERMISSIONS.AOS_REQUIREMENTS_EDIT]: "Create and edit draft requirements",
  [GRANULAR_PERMISSIONS.AOS_REQUIREMENTS_APPROVE]: "Approve requirement sets for planning",
  [GRANULAR_PERMISSIONS.AOS_PROMPTS_VIEW]: "View prompt packs and artifacts",
  [GRANULAR_PERMISSIONS.AOS_PROMPTS_MANAGE]: "Create and approve prompt packs",
  [GRANULAR_PERMISSIONS.AOS_CURSOR_VIEW]: "View Cursor session records",
  [GRANULAR_PERMISSIONS.AOS_CURSOR_EXECUTE]: "Start and capture Cursor sessions",
  [GRANULAR_PERMISSIONS.AOS_EVALUATION_VIEW]: "View evaluations and rubrics",
  [GRANULAR_PERMISSIONS.AOS_EVALUATION_MANAGE]: "Confirm or override evaluation scores",
  [GRANULAR_PERMISSIONS.AOS_KNOWLEDGE_VIEW]: "View knowledge records and patterns",
  [GRANULAR_PERMISSIONS.AOS_KNOWLEDGE_MANAGE]: "Create and promote knowledge records",
  [GRANULAR_PERMISSIONS.AOS_LEARNING_VIEW]: "View learning candidates and review queue",
  [GRANULAR_PERMISSIONS.AOS_LEARNING_REVIEW]: "Approve, reject, defer, or supersede learning candidates",
  [GRANULAR_PERMISSIONS.AOS_LEARNING_PROMOTE]: "Promote approved learning candidates to organizational assets",
  [GRANULAR_PERMISSIONS.AOS_PLAYBOOK_VIEW]: "View agency playbook",
  [GRANULAR_PERMISSIONS.AOS_PLAYBOOK_MANAGE]: "Edit agency playbook content",
  [GRANULAR_PERMISSIONS.AOS_TEMPLATES_VIEW]: "View delivery and prompt templates",
  [GRANULAR_PERMISSIONS.AOS_TEMPLATES_MANAGE]: "Create and activate templates",
  [GRANULAR_PERMISSIONS.AOS_RUBRICS_VIEW]: "View evaluation rubrics",
  [GRANULAR_PERMISSIONS.AOS_RUBRICS_MANAGE]: "Create and activate evaluation rubrics",
  [GRANULAR_PERMISSIONS.AOS_ADMIN]: "Full AOS access within company",
...
export const PERMISSION_GROUPS = {
  ...
  [PERMISSION_CATEGORIES.AOS]: [
    GRANULAR_PERMISSIONS.AOS_DASHBOARD_VIEW,
    GRANULAR_PERMISSIONS.AOS_ENGAGEMENTS_VIEW,
    GRANULAR_PERMISSIONS.AOS_ENGAGEMENTS_MANAGE,
    GRANULAR_PERMISSIONS.AOS_REGISTRY_VIEW,
    GRANULAR_PERMISSIONS.AOS_REGISTRY_MANAGE,
    GRANULAR_PERMISSIONS.AOS_REQUIREMENTS_VIEW,
    GRANULAR_PERMISSIONS.AOS_REQUIREMENTS_EDIT,
    GRANULAR_PERMISSIONS.AOS_REQUIREMENTS_APPROVE,
    GRANULAR_PERMISSIONS.AOS_PROMPTS_VIEW,
    GRANULAR_PERMISSIONS.AOS_PROMPTS_MANAGE,
    GRANULAR_PERMISSIONS.AOS_CURSOR_VIEW,
    GRANULAR_PERMISSIONS.AOS_CURSOR_EXECUTE,
    GRANULAR_PERMISSIONS.AOS_EVALUATION_VIEW,
    GRANULAR_PERMISSIONS.AOS_EVALUATION_MANAGE,
    GRANULAR_PERMISSIONS.AOS_KNOWLEDGE_VIEW,
    GRANULAR_PERMISSIONS.AOS_KNOWLEDGE_MANAGE,
    GRANULAR_PERMISSIONS.AOS_LEARNING_VIEW,
    GRANULAR_PERMISSIONS.AOS_LEARNING_REVIEW,
    GRANULAR_PERMISSIONS.AOS_LEARNING_PROMOTE,
    GRANULAR_PERMISSIONS.AOS_PLAYBOOK_VIEW,
    GRANULAR_PERMISSIONS.AOS_PLAYBOOK_MANAGE,
    GRANULAR_PERMISSIONS.AOS_TEMPLATES_VIEW,
    GRANULAR_PERMISSIONS.AOS_TEMPLATES_MANAGE,
    GRANULAR_PERMISSIONS.AOS_RUBRICS_VIEW,
    GRANULAR_PERMISSIONS.AOS_RUBRICS_MANAGE,
    GRANULAR_PERMISSIONS.AOS_ADMIN,
  ],
};
